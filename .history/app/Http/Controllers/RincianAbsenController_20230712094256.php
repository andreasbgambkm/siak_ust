...
class RincianAbsenController extends Controller
{
    ...
    public function store(Request $request, $id_jadwal)
    {
        ...
        $absensiDosen = AbsensiDosen::where('id_jadwal', $id_jadwal)->latest()->first();
        ...
        if ($absensiMhs) {
            $pertemuanAbsensiDosen = strlen($absensiDosen->pertemuan);
            $jumlahStatusAbsensiMhs = $absensiDosen->pertemuan;
