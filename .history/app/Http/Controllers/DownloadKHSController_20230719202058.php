...
class DownloadKHSController extends Controller
{
    public function show($id)
    {
        ...
        $prodi = Prodi::findOrFail($kdprodi);
        $nidn = $prodi->nidn_kaprodi ;
        $getNamaDosen = Dosen::findOrFail($nidn);
        $namaDosen =  $getNamaDosen->nmdos;
        ...
        <tr>
            ...
            <th rowspan="1" style="text-align: center; width: 260px;">Nama Matakuliah</th>
            <th rowspan="1" style="text-align: center; width: 40px;">Kelas</th>
            <th rowspan="1" style="text-align: center; width: 40px;">Kredit</th>
        ...
        foreach ($dataTabel as $row) {
            ...
            $html .= '<td style="text-align: center;width: 260px;">&nbsp;' . $row['nm_matkul'] . '</td>';
            $html .= '<td style="text-align: center; width: 40px;">&nbsp;' . $row['kelas'] . '</td>';
            $html .= '<td style="text-align: center; width: 40px;">&nbsp;' . $row['sks'] . '</td>';
            $html .= '<td style="text-align: center; width: 40px;"> &nbsp; ' . $row['semester'] . '</td>';
            $html .= '<td style="text-align: center; width: 40px;"> &nbsp; ' . $row['nilai_huruf'] . '</td>';
            $html .= '</tr>';
        ...
        <div style="width: 50%; text-align: leftt;"><b>Maks. sks Semester Berikutnya: '.$maks_ip.'sks</b></div>
        <div style="width: 50%; text-align: right;"><b>Medan, '. $tanggal. '</b></div><br><br>
        <table>
        <tr>
        ...
        <tr>
          ...
          <td style="text-align: center;"><b>'. $namaDosen. '</b></td>
        </tr>
      </table>';
