...
use App\Http\Controllers\DetailKHSController ;
...
Route::group(['middleware' => ['auth:sanctum'],['token.name:API-Application']], function () {
    ...
    Route::get('/suratpkl', [SuratPklController::class,'show']);
    Route::post('/isisuratpkl', [SuratPklController::class,'store']);
    Route::get('/skpembimbing', [SKPembimbingController::class,'show']);
    Route::post('/isiskpembimbing', [SKPembimbingController::class,'store']);
    Route::get('/khs', [KHSController::class,'show']);
    Route::get('/khs/{idTA}', [DetailKHSController::class,'show']);
    Route::get('/transkripnilai', [TranskripNilaiController::class,'show']);
});
