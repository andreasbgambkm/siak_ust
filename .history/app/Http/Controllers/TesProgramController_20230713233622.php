...
class TesProgramController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $surat = TesProgram::where('npm', $npm)->first();
        if ($surat) {
        ...
        return response()->json([
            'message' => "Surat Tes Program berhasil diinput. Silahkan tunggu pangilan dari Tata Usaha!",
        ], 200);
    }
}
