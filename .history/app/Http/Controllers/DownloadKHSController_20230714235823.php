...
class DownloadKHSController extends Controller
{
    public function show($id)
    {
        ...
        <tr>
            ...
            <th rowspan="2" style="text-align: center; width: 40px;">Kredit(K) </th>
            <th rowspan="2" style="text-align: center; width: 40px;">Sem</th>
            <th rowspan="2" style="text-align: center; width: 40px;">Nilai Huruf</th>
        </tr>';
