...
class NilaiController extends Controller
{
    ...
    public function uas()
    {
        ...
        ->join('tbdetailkrs', 'tbkrs.id_krs', '=', 'tbdetailkrs.id_krs')
        ->join('jadwallengkap', 'tbdetailkrs.id_jadwal', '=', 'jadwallengkap.id')
        ->select('jadwallengkap.kd_matkul', 'jadwallengkap.nm_matkul', 'jadwallengkap.sks', 'tbdetailkrs.n_uts', 'tbdetailkrs.n_sk', 'tbdetailkrs.n_tugas', 'tbdetailkrs.n_uts', 'tbdetailkrs.n_uas', 'tbdetailkrs.N_angka')
        ->where('tbkrs.npm', $uid)
        ->where('tbtahun_ajaran.id_ta', $idTa)
        ->where('tbdetailkrs.status_angket', '1')
        ->get();
