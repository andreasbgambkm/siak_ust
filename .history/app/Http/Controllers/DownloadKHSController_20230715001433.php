...
class DownloadKHSController extends Controller
{
    public function show($id)
    {
        ...
        <tr>
            ...
            <th rowspan="1" style="text-align: center; width: 160px;">Nama Matakuliah</th>
        ...
        $html .= '</table><br>
        <div style="width: 50%; text-align: center;">Jumlah (sks):'.$totalSks.'</div><br><br>
        <div style="width: 50%; text-align: right;">IP Semester :'.$ip.'</div><br><br>
        <div style="width: 50%; text-align: center;">Maks. sks Semester Berikutnya:'.$maks_ip.'</div><br><br>
