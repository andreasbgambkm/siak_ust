...
use App\Http\Controllers\DownloadKHSController ;
...
Route::group(['middleware' => ['auth:sanctum'],['token.name:API-Application']], function () {
    ...
    Route::get('/downloadkhs/{id}', [DownloadKHSController::class,'show']);
    Route::get('/detailkwitansi/{kdkwitansi}', [DetailKwitansiController::class,'show']);
    Route::get('/transkripnilai', [TranskripNilaiController::class,'show']);
    Route::delete('krs/{id}', [IsiKRSController::class, 'destroy']);
});
